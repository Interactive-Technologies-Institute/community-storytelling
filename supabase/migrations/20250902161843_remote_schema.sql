...
CREATE OR REPLACE FUNCTION "public"."get_story_like_count"("story_id" bigint, "user_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("count" bigint, "has_liked" boolean)
    LANGUAGE "sql" SECURITY DEFINER
    AS $_$select
  count(*) filter (where story_id = $1) as liked_count,
  exists (
    select 1
    from public.liked_stories
    where user_id = $2 and story_id = $1
  ) as has_liked
from public.liked_stories;$_$;


ALTER FUNCTION "public"."get_story_like_count"("story_id" bigint, "user_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."liked_stories" (
    "id" bigint NOT NULL,
    "inserted_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."liked_stories" OWNER TO "postgres";


ALTER TABLE "public"."liked_stories" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."liked_stories_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."liked_stories"
    ADD CONSTRAINT "liked_stories_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."liked_stories"
    ADD CONSTRAINT "liked_stories_user_id_story_id_key" UNIQUE ("user_id", "story_id");
...
ALTER TABLE ONLY "public"."liked_stories"
    ADD CONSTRAINT "liked_stories_story_id_fkey" FOREIGN KEY ("story_id") REFERENCES "public"."story"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."liked_stories"
    ADD CONSTRAINT "liked_stories_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id");
...
CREATE POLICY "Allow moderators update all map pins moderation" ON "public"."map_pins_moderation" FOR UPDATE USING (( SELECT "public"."authorize"('map.moderate'::"public"."user_permission") AS "authorize"));
...
CREATE POLICY "Allow users to create their own liked stories" ON "public"."liked_stories" FOR INSERT WITH CHECK ((( SELECT "public"."authorize"('story.create'::"public"."user_permission") AS "authorize") AND ("auth"."uid"() = "user_id")));
...
CREATE POLICY "Allow users to delete their own liked stories" ON "public"."liked_stories" FOR DELETE USING ((( SELECT "public"."authorize"('story.delete'::"public"."user_permission") AS "authorize") AND ("auth"."uid"() = "user_id")));
...
CREATE POLICY "Allow users to read their own liked stories" ON "public"."liked_stories" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
ALTER TABLE "public"."liked_stories" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."get_story_like_count"("story_id" bigint, "user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_story_like_count"("story_id" bigint, "user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_story_like_count"("story_id" bigint, "user_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."liked_stories" TO "anon";
GRANT ALL ON TABLE "public"."liked_stories" TO "authenticated";
GRANT ALL ON TABLE "public"."liked_stories" TO "service_role";



GRANT ALL ON SEQUENCE "public"."liked_stories_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."liked_stories_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."liked_stories_id_seq" TO "service_role";
